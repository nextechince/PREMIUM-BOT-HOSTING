...
// Read package.json and get main file
...
🔹 Preparing for deployment...
    ...
    try {
        ...
        if (f_name.endsWith('.zip')) {
            ...
            // Step 3: Detect language and find main file (40-50%)
...
Type the file name or /cancel to cancel
            ...
            // --- For Python projects ---
                ...
                // Check common Python main files
...
const quizQuestions = [
    ...
    },
    {
        ...
        options: ["JavaScript Object Notation", "Java Script Object Notation", "JavaScript Object Normal", "Java Script Object Normal"],
        answer: 0
    },
    {
                ...
                if (mainPath) {
                    ...
                    if (fs.existsSync(path.join(extractDir, 'package.json'))) {
                        ...
                        try {
                            ...
                            await updateProgress(message.chat.id, progressMsgId, 70, '⚠️ Some dependencies failed', f_name, uid);
                        }
                    }
                    ...
                    if (fs.existsSync(path.join(extractDir, 'requirements.txt'))) {
                        ...
                        try {
                            ...
                            await updateProgress(message.chat.id, progressMsgId, 70, '⚠️ Some Python dependencies failed', f_name, uid);
                        }
                    }
